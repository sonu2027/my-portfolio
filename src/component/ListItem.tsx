    ...
    return (
        <>
            <ul className={`${ULstyle}`}>
                ...
                <li className="text-violet-600 font-medium text-center underline text-sm py-1"><a href="https://www.geeksforgeeks.org/user/takeinfo2u/" target="_blank">GeeksForGekks</a></li>
